  ...
  return (
    <div className="w-full mx-auto bg-white border-b 2xl:max-w-7xl z-50">
      <div className="flex flex-col w-full p-5 mx-auto bg-white md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        ...
        <nav
          className="hidden flex-grow md:pb-0 md:flex md:justify-end md:flex-row items-center"
        >
          <Link
          ...
          <div className="inline-flex items-center gap-2 list-none lg:ml-auto">
            ...
            >
              <div>
                <button onClick={() => setOpenProfile((state) => !state)} type="button" className="flex bg-white rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              ...
              <div className="absolute right-0 z-10 w-48 py-1 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabIndex={-1}>
                <Link
                  to="/profile"
        ...
        { openMenu && (
        <nav
          className=" absolute w-full p-4 left-0 top-16 bg-white flex flex-col items-center flex-grow md:hidden"
        >
          {links.map((link) => (
            <Link
